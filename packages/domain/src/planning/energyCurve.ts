 ...
 *   - IOM DRI (2002/2005): EER = (89×вес−100) + рост → для 2 мес ≈ 108 ккал/кг
 *   - ESPGHAN 2005/2022 (term infants) — поддерживает FAO 2004
 *   - Союз педиатров РФ, "Программа оптимизации вскармливания" 2019 —
 *     115 ккал/кг для 0–3 мес (даже выше FAO formula-fed)
 *
 * Прежняя кривая [0,1,2,3,4,5] → [120,109,100,87,86,84] была сдвинута на
 * месяц влево и систематически занижала потребность в 1–3 мес на 8–13 ккал/кг
 * относительно FAO. Заменено на прямой перенос Table 3.3.
 *
