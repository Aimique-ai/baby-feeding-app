import wfaData from "./data/wfa.json" with { type: "json" };
import velocityMonthly from "./data/velocity-monthly.json" with { type: "json" };
import velocityEarly from "./data/velocity-early.json" with { type: "json" };
